...
class Arlo extends EventEmitter {
  ...
  constructor(options) {
    ...
    if (typeof this.config.mfaViaEmail === 'undefined')
      this.config.mfaViaEmail = false;
    ...
    if (this.config.mfaViaEmail) {
      ...
      if (typeof this.config.mobileAuthToken === 'undefined')
        // eslint-disable-next-line no-constructor-return
        return Error('No Arlo mobile auth token param');

      this.mobileAuthToken = this.config.mobileAuthToken;
    }
  ...
  async openLocalMediaLibrary() {
    try {
      ...
      if (typeof this.config.localAppID === 'undefined') {
        // eslint-disable-next-line no-constructor-return
        const err = Error('No local media app ID param');
        debug(err.message);
        throw err;
      }
